...
bucket_name="s3-trigger-event-005"
lambda_func_name="s3-lambda-function-new"
role_name="s3-lambda-sns"
email_address="mahaboobbasha2k1@gmail.com"
...
aws lambda create-function \
  ...
  --runtime "python3.8" \
  --handler "s3-lambda-function/lambda_folder/s3-lambda-function.lambda_handler" \
  --memory-size 128 \
  --timeout 30 \
...
aws sns publish \
  ...
  --message "Hello, This is ypur Shell scripting project"
